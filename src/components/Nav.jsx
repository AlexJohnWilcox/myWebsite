      ...
      <div className={styles.inner}>
        ...
        <nav className={styles.links} onClick={close}>
          ...
          <div className={styles.socials}>
            <a href="https://github.com/AlexJohnWilcox" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/alexjwilcox/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
